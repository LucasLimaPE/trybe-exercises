...
// 2 - Criar uma estrutura de repetição que irá perccorer o array da posição 1, somando 1 a cada loop;
// 3 - Dentro dessa primeira estrutura de repetição terá uma outra estrutura de repetição que irá percorrer da posição 0 até que secondIndex seja menor que o número da posição percorrida no primeiro for, somando 1 a cada loop;
